    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="mx-auto flex max-w-4xl flex-col items-center px-6 pb-12 pt-8">
        ...
        <div className="w-full rounded-3xl bg-gray-100/70 p-5">
          <div className="mx-auto grid max-w-3xl gap-6 sm:grid-cols-2">
            ...
            <CalculatorTile
              ...
              subtitle="Lower % Na through calcium displacement"
            />
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <Link
            href="/"
            className="inline-flex items-center rounded-lg border border-green-200 bg-green-50 px-5 py-3 text-base font-medium text-green-700 shadow-sm transition hover:bg-green-100"
          >
